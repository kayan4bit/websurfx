//! The `pagesearch` module handles scraping from PageSearch.
...
/// PageSearch engine implementation.
pub struct PageSearch {
    parser: SearchResultParser,
}

impl PageSearch {
    /// Creates the PageSearch parser.
...
impl SearchEngine for PageSearch {
    async fn results(
        &self,
        query: &str,
        page: u32,
        ...
        let document: Html = Html::parse_document(
            &PageSearch::fetch_html_from_upstream(self, &url, header_map, client).await?,
        );
