//! The `brave_search` module handles scraping results from Brave Search.
...
impl BraveSearch {
    /// Creates the Brave Search parser.
...
impl SearchEngine for BraveSearch {
    async fn results(
        ...
        let document: Html = Html::parse_document(
            &BraveSearch::fetch_html_from_upstream(self, &url, header_map, client).await?,
        );
