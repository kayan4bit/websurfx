//! The `search_engineai` module handles scraping from Whoogle instance.
...
pub struct SearchEngineAI {
    parser: SearchResultParser,
}

impl SearchEngineAI {
    /// Creates the SearchEngineAI parser.
...
impl SearchEngine for SearchEngineAI {
    async fn results(
        &self,
        query: &str,
        page: u32,
        ...
        let document: Html = Html::parse_document(
            &SearchEngineAI::fetch_html_from_upstream(self, &url, header_map, client).await?,
        );
